...
public class CurrencyLawson {
     ...
     */
    public CurrencyLawson(Double amount, String currency) {
        this.amount = amount;
    ...
    public Double addDifferentCurrencies(Double amount1, String currency1, Double amount2, String currency2) {
        CurrencyLawson c1 = new CurrencyLawson(amount1, currency1);
        CurrencyLawson c2 = new CurrencyLawson(amount2, currency2);
